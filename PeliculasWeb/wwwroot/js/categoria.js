...
function loadDataTable() {
    dataTable = $('#tblCategorias').DataTable({
        "ajax": {
            ...
            "url": "/Categorias/GetTodasCategorias",//URL que apunta al metodo del controlador (categoriasController) vcorresponde al método en el controlador GetTodasCategorias
            "type": "GET",
